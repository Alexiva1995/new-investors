        ...
        <table class="" style="width: 100%;">
          <tbody>
            ...
            <tr>
              ...
              <td style="width: 50%;"><p class="text-center"><u>{{$contract->getUser->fullname}}<u></p></td>
            </tr>
            <tr>
